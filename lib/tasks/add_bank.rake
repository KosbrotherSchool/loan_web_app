namespace :add_bank do
	...
	task :add_bank_seeds => :environment do
		...
		Bank.create(name:"兆豐銀行")
		Bank.create(name:"渣打銀行")
		Bank.create(name:"台新銀行")
		Bank.create(name:"台北富邦")
		Bank.create(name:"遠東銀行")
		Bank.create(name:"匯豐銀行")
		Bank.create(name:"星展銀行")
		Bank.create(name:"澳盛銀行")
		Bank.create(name:"新光人壽")
		Bank.create(name:"富邦人壽")
		Bank.create(name:"合作金庫")
		Bank.create(name:"三商美邦人壽")
		Bank.create(name:"台灣銀行")
		Bank.create(name:"彰化銀行")
		Bank.create(name:"第一銀行")
		Bank.create(name:"台中商銀")
		Bank.create(name:"台灣中小企銀")
		Bank.create(name:"全國農業金庫")
		Bank.create(name:"上海銀行")
		Bank.create(name:"元大銀行")
		Bank.create(name:"華南銀行")
		Bank.create(name:"土地銀行")
		Bank.create(name:"玉山銀行")
