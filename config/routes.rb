...
Rails.application.routes.draw do
  ...
  patch "backstage/update_un_reply_credit_case" => "backstage#update_un_reply_credit_case" 
  get "backstage/credit_cases/:credit_case_id" => "backstage#credit_case_detail"
